...
const AuthModal: React.FC<AuthModalProps> = ({
  ...
  const RequirementItem = ({ met, text }: { met: boolean; text: string }) => (
    ...
    >
      ...
      >
        {met && <Check size={8} className="text-foreground" />}
      </div>
      <span>{text}</span>
    </motion.div>
  );
    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="fixed inset-0 bg-background/40 backdrop-blur-sm flex items-center justify-center z-50 p-4"
          onClick={onClose}
        >
          <motion.div
            ...
            className="bg-popover backdrop-blur-xl border border-border rounded-lg shadow-2xl w-full max-w-md relative max-h-[90vh] overflow-y-auto"
                  ...
                  >
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-4 py-3 bg-background/20 border border-border rounded-md text-foreground placeholder-muted-foreground focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-colors"
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      className="w-full pl-10 pr-4 py-3 bg-background/20 border border-border rounded-md text-white placeholder-muted-foreground focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-colors"
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      className="w-full pl-10 pr-10 py-3 bg-background/20 border border-border rounded-md text-white placeholder-muted-foreground focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-colors"
                      placeholder={
                        mode === 'login'
                          ? 'Enter your password'
